...
def invertido():
    ...
    #se debe declarar asi ya que de esa manera aseuguro tomar siemore el ultimo indice88
...
#beCheerful(name=5, repeat='hola')	# salida: good morning michael (repeated on 5 lines)
